...
function App() {
  ...
  const handleAddTodo = (event) => {
    ...
    if (todos.some((todo) => todo.text.trim().toLowerCase() === formattedTask.toLowerCase())) {
  ...
  return (
    <main className="todo-app">
      <div className="todo-header">
        <h1>Todo List</h1>
        {todos.length > 0 ? (
          <button type="button" className="delete-all-btn" onClick={handleOpenDeleteAllModal}>
            Delete All
          </button>
        ) : null}
      </div>
            ...
            <li key={todo.id} className="todo-item">
              <label>
                <input
                  ...
                  disabled={deletingTodoId === todo.id || editingTodoId === todo.id}
        ...
        >
          ...
          >
            ...
            <div className="modal-actions">
              <button type="button" className="modal-btn-yes" onClick={handleConfirmDeleteAllTodos}>
                Yes
              </button>
              <button type="button" className="modal-btn-no" onClick={handleCancelDeleteAllTodos}>
                No
              </button>
            </div>
          </div>
